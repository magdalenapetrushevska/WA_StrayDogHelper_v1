...
namespace WA_StrayDogHelper_v1.Data.Migrations
{
    ...
    [Migration("20210711121238_AddDbSetInAdb")]
    partial class AddDbSetInAdb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WA_StrayDogHelper_v1.Models.DomainModels.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WA_StrayDogHelper_v1.Models.DomainModels.Message", b =>
                {
                    b.HasOne("WA_StrayDogHelper_v1.Models.IdentityModels.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("WA_StrayDogHelper_v1.Models.IdentityModels.ApplicationUser", "Sender")
                        .WithMany()
